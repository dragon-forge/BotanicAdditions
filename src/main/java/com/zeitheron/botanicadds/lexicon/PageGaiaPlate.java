...
public class PageGaiaPlate extends PageRecipe
{
	...
	final List<RecipeGaiaPlate> recipes;
	int ticksElapsed = 0;
	int recipeAt = 0;
	
	public PageGaiaPlate(String unlocalizedName, List<RecipeGaiaPlate> recipes)
	{
		super(unlocalizedName);
		this.recipes = recipes;
	}
	
	public PageGaiaPlate(String unlocalizedName, RecipeGaiaPlate recipe)
	{
	...
	{
		for(RecipeGaiaPlate recipe : recipes)
	...
	{
		RecipeGaiaPlate recipe = recipes.get(recipeAt);
